def string_methods():
    ...
    print(f"Count: {frase.count("e")}")
    print(f"Countiene Python: {"Python" in frase}")
    print(f"Countiene Java: {"Java" in frase}")
    print(f"Slice: {frase[0:6]}")
    print(f"Paso: {frase[0:6:2]}")
    print(f"Reverso:{frase[-35:-45:-1]}")
    print(f"Formato: {nombre.strip()} sabe {frase[0:6]}")
    print(f"{multilinea[0:7]}\n{multilinea[9:19].strip()}\n{multilinea[19:].strip()}")
